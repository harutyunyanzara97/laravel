                                        ...
                                        @if($comment->reply)
                                            @foreach($comment->reply as $reply)
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    @if($reply->images)
                                                    <div class="mt-3 ml-5">
                                                        <img src="{{asset('images/'.$reply->images)}}" class="img-fluid" width="100px" height="100px"/>
                                                    </div>
                                                    @endif
                                                </div>
                                                <a href="" class="comment-section comments d-flex align-items-center">
                                                    ...
                                                    <span @auth class="reply_to_reply" data-id="{{$reply->id}}"
                                                          @else data-toggle="modal"
                                                          class="replyToReply" aria-haspopup="true" aria-expanded="false"
                                                          data-target=".login-modal" @endauth>Reply</span>
                                                ...
                                                @if($reply->replies)
                                                    @foreach($reply->replies as $replies)
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            @if($replies->images)
                                                                <div class="mt-3 ml-5">
                                                                    <img src="{{asset('images/'.$replies->images)}}" class="img-fluid" width="100px" height="100px"/>
                                                                </div>
                                                            @endif
                                                        </div>
                                                        <a href="" class="comment-section comments d-flex align-items-center">
                                                            ...
                                                            <span @auth @if($replies) class="answer" data-id="{{$reply->id}}"  @else class="reply_to_reply" data-id="{{$reply->id}}"   @endif
                                                                  @else data-toggle="modal"
                                                                  class="reply_to_reply" aria-haspopup="true" aria-expanded="false"
                                                                  data-target=".login-modal" @endauth>Reply</span>
    ...
    @csrf
        ...
        $('#payment-submit').click(function () {
            ...
            $.ajax({
                ...
                {
                    $('#stripeModal #card-errors').html(`<p style="color:black">${response}</p>`);
                },
                error: function (err) {
