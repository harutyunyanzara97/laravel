                    ...
                    <div class="flex-1  w-100">
                        <form method="POST" class="pt-2" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                <input type="email" type="email" id="email" name="email" class="form-control pr-input  @error('email') is-invalid @enderror"  value="{{ old('email') }}" required autocomplete="email"
                                       placeholder="Email">
                                    @error('email')
