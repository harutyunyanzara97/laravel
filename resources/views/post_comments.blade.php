                    ...
                    <div class="resources-forum-left">
                        ...
                        <div class="d-flex justify-content-between borderedPost">
                            <a href="" class="comment-section d-flex align-items-center">
                                ...
                                <img src="{{asset('images/icon1.png')}}" width="30px" height="30px" class="ml-3">
                            </a>
                        ...
                        @if($post->comments) @foreach($post->comments as $comment)
                            <div class="banner d-flex mt-4">
                                <div class="d-flex">
                                    @if($postUser->user->avatar_url)<img src="{{asset('images/'.$postUser->user->avatar_url)}}" class="img-fluid logo" width="24px" height="24px"/>@endif
                                    <a href="{{route('profile')}}" style="color:#fff;margin-left:8px;">{{$user->name}} </a>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="19" viewBox="0 0 19 19"
                                         aria-label="Admin"
                                         class="_3LDKX forum-icon-fill forum-icon-fill _1zT4G" style="fill-rule: evenodd;margin-left:8px;">
                        ...
                        <div>
                         <p> {{$comment->description}}</p>
                            ...
                            <a href="" class="comment-section d-flex align-items-center">
                                ...
                                <span>Reply</span>
                                    <i class="fa fa-heart like" data-id={{$comment->id}}></i></a>
                        @endforeach @endif
                         <form action="{{url('insertComment')}}" method="post" class="mt-5" enctype="multipart/form-data">
                             @csrf
                        ...
                        <div class="">
                            ...
                            <input type="text" name="description" class="txt" placeholder="Write a comment">
                        </div>
