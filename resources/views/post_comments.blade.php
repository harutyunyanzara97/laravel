            ...
            <div class="navbar-expand-md navbar-dark">
                ...
                <div class="registration-banner">
                    ...
                    <div class="d-flex">
                        ...
                        <button type="button" class="btn-generic  dropdown-toggle " data-toggle="modal"
                ...
                <div class="main-container resources-forum mt-0">
                    ...
                    <div class="resources-forum-left">
                        <div class="banner d-flex">
                            <div class="d-flex">
                                <img src="images/user-icon.svg" class="img-fluid logo " width=50px/>
                                <svg xmlns="http://www.w3.org/2000/svg" width="19" viewBox="0 0 19 19"
                                     aria-label="Admin"
                                     class="_3LDKX forum-icon-fill forum-icon-fill _1zT4G" style="fill-rule: evenodd;">
                        ...
                        <h2>Welcome to the Resources Forum!
                        </h2>
                        <p>
                            If you are searching for resources in your area, please search for your zip code, town/city,
                            and
                            expand from there.

                        </p>
                        <p>
                            If you are providing a resource, please create a post with the zip code, town/city, and
                            include
                            the resource you are providing in the title
                        </p>
