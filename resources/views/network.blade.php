        ...
        <div class="network-section">
            ...
            <div class="main-container">
                ...
                <div class="network-panel">
                    <div class="network-heading" style="margin-top:15px">
                        <h2>
                            The Network
                        </h2>
                        <p style=" font-size: 24px;
                            line-height: 30px;
                            text-align: center;">
                            An Anonymous Social Platform to Connect to Individuals, Businesses, and Community
                            Resources
                ...
                <div class="main">
                    <div class="dropdown show">
                        <a class="btn  dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                           style="background:rgba(78, 102, 54, 0.8);">
                            Filter categories
                        </a>

                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item color-white created" href="#">Last created</a>
                            <a class="dropdown-item commented" href="#">Most commented</a>
                            <a class="dropdown-item posted" href="#">Most posted</a>
                        </div>
                    </div>
                        ...
                        <div class="network-banner">
                            <div class="d-flex">
                                ...
                                <div class="network-banner-details">
                                    ...
                                    <div>
                                        <img src="images/right-arrow.png" class="arrow-left" data-id="{{$category->id}}">
                                    </div>
                            </div>
                    ...
                    $(data).each(function (val, i) {
                        ...
                        $('.main').append(`<div class="network-banner">
                            <div class="d-flex">
                                @if($category->img_url)
                        <div class="network-img-block">
                        <img src='{{asset("images")}}/${img}' id="img-{{$category->id}}" class="img-fluid catImg">
                                    </div>
                                @endif
                        <div class="network-banner-details">
                            <a href="{{route('showPosts',$category->id)}}" id="name-{{$category->id}}">
...
@auth
        ...
        $('.commented').on('click', function () {
            $.ajax({
                type: 'get',
                url: '{{URL::to('filterCatByComments')}}',
                success: function (data) {
                    $('.main').empty();
                    $(data).each(function (val, i) {
                        console.log(i);
        ...
        $('.arrow-left').on('click',function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    // $('.network-banner').css('z-index','0');

                }
            })
        })
        $(document).on('click', '.cancel-btn', function (event) {
            $(this).closest('.postbar').css('display', 'none');
        });
    </script>
@endsection
