                ...
                <div class="main-container">
                    ...
                    @foreach($categories as $category)
                        <div class="network-banner">
                            <div class="d-flex">
                                <img src="images/item.png" class="img-fluid">
                            ...
                            <div class="d-flex follow-banner">
                                <a href="@if(auth()->guest()){{route('signup')}} @else('#') @endif" data-id="{{$category->id}}" class="follow">Follow</a>
                                <div class="follow-details">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <button type="button" class="dropdown-item" data-toggle="modal"
                                            ...
                                            <a href="{{route('edit', $category->id)}}" class="edit p0">Edit Category</a>
                                        </button>
...
<script>
    ...
    //         type:"get",
    //         url:'edit',
    //         data: {_token: $('meta[name="csrf-token"]').attr('content'),idd:editedId},
    //         success:function (r) {
    //             $('.modalOpen').prepend(r);
    //         }
    //
