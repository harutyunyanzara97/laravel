                ...
                <div class="menu-box">
                    ...
                    <div class="navbar-collapse collapse" id="collapsingNavbar">
                        <ul>
                            ...
                            <li>
                                <a href="{{route('members')}}"  class="active-item">
                                    Members
                                </a>
                            </li>
                        </ul>
        ...
        <div class="members-section">
            ...
            <div class="members-box">
                <div class="member-item">
                    <img src="{{asset('images/'.$user->avatar_url)}}" class="img-fluid " alt="member" title="member">
                </div>
                <h2 class="member-name">{{$user->name}}</h2>
                <button type="button" class="member-following">Following</button>
            </div>
            @endforeach
        </div>
    </main>
