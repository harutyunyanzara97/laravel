        ...
        <div class="account-form comments-container">
            ...
            @foreach($memberPosts as $post)
                <div class="green-box mb-3">
                        ...
                        <div class="d-flex">
                            <div class="follow-details">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{route('deletePost',$post->id)}}">
                    ...
                    <div class="d-flex ml-3 flex-column">
                        <a href="{{route('comments',$post->id)}}" class="text-white mb-3">{{$post->title}}</a>
                        <a href="{{route('comments',$post->id)}}" class="text-white mb-3"
                           style="word-break: break-all;">{{$post->description}}</a>
                        <a href="{{route('comments',$post->id)}}" class="text-white mb-3">{{count($post->comments)}}
                            comments</a>
                    </div>
