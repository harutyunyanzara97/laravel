            ...
            @foreach($myPosts as $myPost)
                <div class="green-box mb-3">
                    ...
                    <div class="d-flex ml-3 flex-column">
                        ...
                        <a href="{{route('comments',$myPost->id)}}" class="text-white mb-3"
                           style="word-break: break-all;">{{$myPost->description}}</a>
                        <a href="{{route('comments',$myPost->id)}}" class="text-white mb-3">{{count($myPost->comments)}}
                            comments</a>
                    </div>
