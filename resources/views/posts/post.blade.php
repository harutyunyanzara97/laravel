                    ...
                    <div class="card position-static">
                        <div class="card-header" id="headingOne">
                            <h5 class="mb-0">
                                <button class="btn-link" data-toggle="collapse" data-target="#collapseOne"
                                        aria-expanded="true" aria-controls="collapseOne">Post Info
                                </button>
                            </h5>
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                            ...
                            <form method="post" id="editcat" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="cat_id" class="cat_id" value="{{$modal_post->id}}">
                                <div class="card-body p-0">
                                    <div>
                                        ...
                                        <input type="text" name="title" class="catname"
                                               value="{{$modal_post->title}}">
                                    </div>
                                    <div>
                                ...
                                <div class="container p-0">
                                    <div class="avatar-upload">
                                        ...
                                        <div class="avatar-preview">
                                            <div id="imagePreview"
                                                 style="background-image: url({{asset('images/'.$modal_post->images)}})"
                                                 alt="">
                                            </div>
                                        </div>
                                    </div>
    ...
    $("#editcat").on("submit", function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#title-' + response.id).text(response.title);
